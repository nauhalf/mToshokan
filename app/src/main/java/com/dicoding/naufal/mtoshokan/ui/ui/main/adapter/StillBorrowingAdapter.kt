...
class StillBorrowingAdapter(private val list: MutableList<BorrowingBook>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class ViewHolder(private val view: View) : RecyclerView.ViewHolder(view) {
        fun bind(book: BorrowingBook) {
            ...
            val remaining = book.returnDate?.getRemaingDays()
